    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        <nav className="hidden items-center gap-7 text-sm text-slate-400 md:flex">
          <button onClick={onDashboard} className="transition-colors duration-150 hover:text-white">
            Dashboard
          </button>
        ...
        <div className="flex items-center gap-3">
          {currentUser && (
            <div className="hidden rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-right md:block">
              ...
              <p className="text-[10px] uppercase tracking-[0.18em] text-cyan-200">Signed in</p>
            </div>
          )}
